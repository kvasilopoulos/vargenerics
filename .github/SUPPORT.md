# Getting help with vargenerics

Thanks for using vargenerics. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/vargenerics/issues) to make sure the 
